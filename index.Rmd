...
knitr::write_bib(c(
  .packages(), 'bookdown', 'knitr', 'rmarkdown', "x3ptools", "bulletxtrctr", "magrittr", "dplyr", "PRROC", "DescTools", "protoclust", "EBImage", "blackboxstudyR", "rstantools", "rstan", "RColorBrewer", "tidyr", "ggplot2", "gghighlight", "ggpubr", "caret", "shoeprintr", "patchwork", "purrr"
), 'bib/packages.bib')
