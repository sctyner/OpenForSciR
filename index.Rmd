...
knitr::write_bib(c(
  .packages(), 'bookdown', 'knitr', 'rmarkdown', "x3ptools", "bulletxtrctr", "magrittr", "dplyr", "PRROC", "DescTools", "protoclust", "EBImage", "rstantools", "rstan", "RColorBrewer", "tidyr", "ggplot2", "gghighlight", "ggpubr", "bmp"
), 'packages.bib')
```
