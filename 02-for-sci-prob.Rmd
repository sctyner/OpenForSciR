...
2. Data: This section covers the form of the forensic evidence and describes how that evidence is converted into computer-readable format for analysis in `R`. It will also provide the reader with an example dataset, including the type and structure of data objects that are required for the analyses. 
