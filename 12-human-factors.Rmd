...
The case study will make use of the `blackboxstudyR` R package, which provides functions for working with the black box data, implementations of basic IRT models in the MCMC sampler Stan (CITE STAN), and plotting functions for results. Main Functions include: 
...
person_mcmc_intervals(nci_model) %>% 
...
person_mcmc_intervals(pc_model) %>%
