...
The R package `caret` (**C**lassification **A**nd **RE**gression **T**raining) is used for applied predictive modeling. We use it here for fitting a random forest model to our data using cross-validation and downsampling.  (BLAH....)
