...
exampleImage2 <- readCartridgeImage(system.file("extdata", "NBIDE R BF 129.png", package = "cartridges"))
plotImage(exampleImage2, type = "original")
```
...
plotImage(processedExample2, type = "any")
```
